...
#include "my_roobot_interfaces/msg/detail/led_state_array__rosidl_typesupport_fastrtps_c.h"
...
using _LedStateArray__ros_msg_type = my_roobot_interfaces__msg__LedStateArray;
...
size_t get_serialized_size_my_roobot_interfaces__msg__LedStateArray(
  const void * untyped_ros_message,
...
static uint32_t _LedStateArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_roobot_interfaces__msg__LedStateArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_roobot_interfaces
size_t max_serialized_size_my_roobot_interfaces__msg__LedStateArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _LedStateArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_roobot_interfaces__msg__LedStateArray(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_roobot_interfaces, msg, LedStateArray)() {
